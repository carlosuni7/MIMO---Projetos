...
// Se o objeto chamar Dev. o This é trocado por "novoDev"
...
localStorage.setItem("devs",JSON.stringify(arrayDevs))
localStorage.setItem("brendo",JSON.stringify(perfilDev))
let b = JSON.parse(localStorage.getItem("brendo"))
